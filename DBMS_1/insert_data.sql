...
-- ============================================================
-- Populates the covid_cases table with sample records for:
--   India, USA, and UK across multiple reporting dates.
-- ============================================================

USE covid_db;

-- ---------------------------------------------------
-- Insert sample records for India
-- ---------------------------------------------------
...
-- ---------------------------------------------------
-- Insert multiple records in a single INSERT statement
-- ---------------------------------------------------
INSERT INTO covid_cases (country, report_date, confirmed_cases, deaths, recoveries, population)
VALUES
